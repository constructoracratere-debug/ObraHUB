...
const conversations = [
  { id: "1", title: "Recubrimiento mínimo columnas", date: "Hoy" },
  { id: "2", title: "Resistencia del concreto NSR-10", date: "Ayer" },
  { id: "3", title: "Cargas de viento en edificios", date: "3 jun" },
  { id: "4", title: "Separación muros cortafuego", date: "1 jun" },
  { id: "5", title: "Normativa accesibilidad rampas", date: "28 may" },
];
...
export default function Home() {
  ...
  const showHero = messages.length === 0 && !activeId && !activeProjectSlug;
                    ...
                    <li key={conv.id}>
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1">
                          ...
                          <span className="mt-0.5 block text-xs text-slate-600">{conv.date}</span>
                        </span>
                      </button>
                    </li>
                  ))}
          ...
          >
            ...
            {!sidebarCollapsed && (
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-medium text-slate-200">Profesional</p>
                <p className="truncate text-xs text-slate-500">Plan gratuito</p>
              </div>
            )}
          </div>
        </div>
                  ...
                  {messages.length > 0 ? (
                    ...
                    <>
                      <div className="flex justify-end">
                        <div className="max-w-[88%] rounded-2xl rounded-br-md bg-gradient-to-br from-blue-600 to-blue-700 px-4 py-3.5 text-sm leading-relaxed text-white shadow-lg shadow-blue-900/25 sm:max-w-[80%]">
                      ...
                      <div className="flex gap-3 sm:gap-3.5">
                        ...
                        <div className="max-w-[88%] space-y-3 rounded-2xl rounded-tl-md border border-white/[0.08] bg-[#0a1120]/90 px-4 py-4 text-sm leading-relaxed text-slate-300 shadow-sm sm:max-w-[80%]">
                          <p>
                            Según la NSR-10, el recubrimiento mínimo para columnas expuestas depende del tipo de
                            exposición y el diámetro de la armadura longitudinal. Para elementos estructurales en
                            interiores con condiciones normales de exposición, se aplican los valores mínimos
                            establecidos en el Capítulo C.5.
                          </p>
