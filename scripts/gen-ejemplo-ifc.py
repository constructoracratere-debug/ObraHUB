...
def rprof(i, w, h, px, py):
    ...
    A(f"#100{i}= IFCAXIS2PLACEMENT2D(IFCCARTESIANPOINT(({px},{py})),#15);")

def solid(i, prof, dx, dy, dz, depth):
    A(f"#{i}= IFCEXTRUDEDAREASOLID(#{prof},#200{i},#16,{depth});")
    A(f"#200{i}= IFCAXIS2PLACEMENT3D(IFCCARTESIANPOINT(({dx},{dy},{dz})),#16,#17);")
...
A("#90= IFCRECTANGLEPROFILEDEF(.AREA.,$,#10090,0.3,0.3); #10090= IFCAXIS2PLACEMENT2D(IFCCARTESIANPOINT((0.15,0.15)),#15);")
product(131, 131, "IFCCOLUMN", "Columna-C2-Concreto-4000psi", 91, 5.7, 0.0, 0, 2.5)
A("#91= IFCRECTANGLEPROFILEDEF(.AREA.,$,#10091,0.3,0.3); #10091= IFCAXIS2PLACEMENT2D(IFCCARTESIANPOINT((0.15,0.15)),#15);")
product(132, 132, "IFCCOLUMN", "Columna-C3-Concreto-4000psi", 92, 0.0, 3.7, 0, 2.5)
A("#92= IFCRECTANGLEPROFILEDEF(.AREA.,$,#10092,0.3,0.3); #10092= IFCAXIS2PLACEMENT2D(IFCCARTESIANPOINT((0.15,0.15)),#15);")
product(133, 133, "IFCCOLUMN", "Columna-C4-Concreto-4000psi", 93, 5.7, 3.7, 0, 2.5)
A("#93= IFCRECTANGLEPROFILEDEF(.AREA.,$,#10093,0.3,0.3); #10093= IFCAXIS2PLACEMENT2D(IFCCARTESIANPOINT((0.15,0.15)),#15);")
